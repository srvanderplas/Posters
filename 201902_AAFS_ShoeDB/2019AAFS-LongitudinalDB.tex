...
\headerbox{Adidas Seeley - 2D Digital Scan}{name=lswa,column=2,span=1,above=bottom}{
\vspace{.5em}
...
\headercolorbox{Database Features}{csafegreen}{name=features,column=1,above=lswa,below=url}{
...
\headercolorbox{Build A Query}{csafegreen}{name=baq,column=2,below=goals,above=lswa}{
\vspace{.2em}
...
\headerbox{Nike Winflo - Film Prints}{name=lswn,column=1,above=bottom,below=features}{
\vspace{.5em}
