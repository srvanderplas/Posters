...
\centering
\bf\large\url{https://data.csafe.iastate.edu/DataPortal/}
...
\headercolorbox{Database Features}{csafegreen}{name=features,column=1,below=url}{
...
\headercolorbox{Goals}{csafelightblue}{name=goals,column=2,span=1,below=url}{
...
\headercolorbox{Build A Query}{csafegreen}{name=baq,column=2,below=goals}{
\vspace{.2em}
...
\captionof{figure}{Query Build Interface}
\end{minipage}
...
\headerbox{Nike Winflo - Film Prints}{name=lswn,column=1,above=bottom,below=features,below=baq}{
\vspace{.5em}
...
\headerbox{Adidas Seeley - 2D Digital Scan}{name=lswa,column=2,span=1,above=bottom,below=baq}{
\vspace{.5em}
