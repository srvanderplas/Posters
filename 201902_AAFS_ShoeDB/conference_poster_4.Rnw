...
\definecolor{csafedarkblue}{rgb}{0,.227,0.439} % Used for content box headers
...
\headerbox{Access the Database}{name=url,column=1,row=0,span=2,boxpadding=2mm,headerColorOne=csafered,headerColorTwo=csafered,borderColor=csafered}{
...
\headerbox{Nike Winflo - Film Prints}{name=lswn,column=1,below=url,boxpadding=2mm}{
\hspace{-.5em}\begin{tabu} to \textwidth {X[c]X[c]X[c]X[c]}
\includegraphics[height=4.8cm,trim=20 0 20 0,clip=true,cframe=csafered]{043758L_20180109_5_1_1_csafe_kruse-basulto-elias-kruse.pdf} &
\includegraphics[height=4.8cm,trim=20 0 20 0,clip=true,cframe=csafered]{043758L_20180131_5_1_1_csafe_boekhoff_kruse_zwart.pdf} &
\includegraphics[height=4.8cm,trim=20 0 20 0,clip=true,cframe=csafered]{043758L_20180307_5_1_1_basulto_silerio_jekruse} &
\includegraphics[height=4.8cm,trim=20 0 20 0,clip=true,cframe=csafered]{043758L_20180411_5_1_1_bryson_kruse_kruse.pdf}\\
...
\headerbox{Adidas Seeley - 2D Digital Scan}{name=lswa,column=2,span=1,below=url,boxpadding=2mm}{
